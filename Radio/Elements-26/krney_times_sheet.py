...
TRACKS = [
    ...
    ("10:16", "Orange",             True,  ""),
    ("11:06", "God speed",          True,  "first time crossed out; 11:06 beside it"),
    ("13:56", "Type Shit",          True,  ""),
    ("16:47", "Wet me",             False, "name and last digit both overwritten"),
    ("18:36", "Telekness",          False, "time overwritten; name may be 'Telekinesis'"),
    ("21:04", "Gimme Gimme",        True,  ""),
    ("23:00", "Carry me home",      True,  ""),
    ("25:41", "Feel the vibe",      False, "last digit unclear"),
    ("29:11", "Forever young",      True,  "first time crossed out; 29:11 beside it"),
    ("32:22", "The Fade",           False, "could be 'The Jade'"),
    ("34:18", "Feel it in my",      True,  "title looks unfinished on the page"),
...
for i, (start, name, sure, note) in enumerate(TRACKS, 1):
    mark = "  " if sure else " ?"
    A(" %2d%s  %-7s  %-28s  %s" % (i, mark, start, name, note))
A("-" * 86)
A("")
...
A("   Cannot be listed yet. The handwritten sheet has song names and times but no")
A("   artists and no genres, so anything here would be guesswork. Confirm the names")
A("   above and I will match them and produce this block for real.")
A("")
